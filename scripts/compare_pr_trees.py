#!/usr/bin/env python3
"""Fail closed unless a PR commit adds exactly one new immutable archive blob."""
...
def validate_archive_tree_change(base: dict[str, TreeEntry], candidate: dict[str, TreeEntry]) -> str:
    ...
    if deleted or modified or len(added) != 1:
        raise SystemExit(
            "archive PR must add exactly one committed 100644 blob and modify/delete none; "
